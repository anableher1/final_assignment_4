...
Kay: These two tables show that countries that have had revolutions display lower growth rates and lower gdp than countries that have had zero revolutions. This can be seen most clearly in the mean and median, though it is interesting to note that whilst the minima for both tables are different, the maxima are not really that far apart.  
...
#The p-value is 0.06871. This value refers to the probability that there is no significant difference in growth between revolutionary and non-revolutionary is equal to 6.8%
...
#The variable rgdp60 refers to the value of GDP per capita in 1960, converted to 1960 US dollars. This can be a helpful variable, as countries in different developing stages generally display different growth rates. For example, a developed country in 1960 would display less growth in the period 1960-1995 than a developing country would.
...
#Education is the main driver of economic growth, because it is the most statistically significant effect.
