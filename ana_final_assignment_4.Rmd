...
Kay: These two tables show that countries that have had revolutions display lower growth rates and lower gdp than countries that have had zero revolutions. This can be seen most clearly in the mean and median, though it is interesting to note that whilst the minima for both tables are different, the maxima are not that far apart.  
